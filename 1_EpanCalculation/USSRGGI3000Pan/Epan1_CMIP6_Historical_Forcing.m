...
OutputPath_Epan = 'E:\PenPanV3\VariableStorage\MonthlyVar\Var_GGI3000Epan';
...
for i_GCM = 1 : length(GCM_Ensemble)
    ...
    Epan = PenPan_V3_GGI3000(pan_pars , lat_05deg , elevation_05deg ,...
        r1.rsds , r1.rsdt , r1.rlds , r1.sfcWind , r1.tas , r1.huss , r1.ps); % Epan(m/s)
    
    %% (2.5) Save the result
    save(strcat(OutputPath_Epan , '\Historical\Epan_Historical_',GCM) , 'Epan');
