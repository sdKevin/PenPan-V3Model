function Epan = PenPan_V3_GGI3000(pan_pars , latd , Elevation , Sg , Ra , Li , U10 , Ta , Sh , Pa)
...
n = (0.01./2) .^ ((0.37-0.0881.*log(U2))./(1-0.0881.*log(0.2))); % n has not adopted the extrapolation of optimized parameters as Shown in Wang et al.2018
