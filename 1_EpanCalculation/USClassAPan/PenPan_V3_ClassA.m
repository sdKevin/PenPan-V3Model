function Epan = PenPan_V3_ClassA(pan_pars , latd , Elevation , Sg , Ra , Li , U10 , Ta , Sh , Pa)
...
n = (0.375./2) .^ ((0.37-0.0881.*log(U2))./(1-0.0881.*log(0.2))); % n has not adopted the extrapolation of optimized parameters as Shown in Wang et al.2018
q = -0.53; % laminar flow over the pan water surface, Epan_A is sensitive to this parameter
...
Ln = Ln_w + Ln_wall + Ln_rim + Ln_rim_pie;
clear Li Ta
...
% Sn_bot(Sn_bot<0)=0;
Sn = Sn_w + Sn_wall + Sn_rim + Sn_rim_pie;
